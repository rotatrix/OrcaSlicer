        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // version
    {
        ...
        wxStaticText* credits_string = new wxStaticText(this, wxID_ANY, wxString::Format("Rotatrix Build (unofficial) - %s", std::string(GIT_COMMIT_HASH)), wxDefaultPosition, wxDefaultSize);
